...
4. 普通进展写到结果即可，不强行补一段抽象道理、口号或“产品启示”。
5. 决策类帖子必须写清候选方案、放弃了什么或承担什么代价，以及为什么这个选择并不显然；结尾保留一个真实未决问题，让有相关经验的人能够给出不同判断。如果没有真实取舍和未决问题，只留在开发记录中，不包装成决策帖。
...
- 不用 `What do you think?` 这类空泛问题。决策类帖子结尾要问一个具体、可回答的问题，例如读者会选哪种方案、接受哪项代价，或会用什么数据决定下一步。
...
- 是否清楚说明做了什么和得到什么结果？
- 如果是决策类帖子，是否写清真实取舍，并在结尾留下一个尚未确定、读者能具体回答的问题？
- 是否删除了文章腔、总结腔和抽象口号？
...
| 37 | 2026-09-13 | [Small preview, full-resolution export](posts/37-small-preview-full-resolution-export.md) | 已发布 |
| 38 | 2026-09-13 | [Natural-language search without sharing receipts](posts/38-natural-language-search-without-sharing-receipts.md) | 已发布 |
